...
class MockedGCSBlob:
    ...
    def __init__(self, bucket: "MockedGCSBucket", name: str) -> None:
        self.__bucket = bucket
        self.__name = name

    def exists(self, client: "MockedGCSClient") -> bool:
        return client.check_file_exists(bucket=self.__bucket.bucket_name, file_path=self.__name)
...
class MockedGCSBucket:
    ...
    def write_file(self, client: "MockedGCSClient", data: bytes, file_path: str):
        client.write_data(bucket=self.__bucket_name, data=data, full_path=file_path)
...
class MockedGCSClient:
    ...
    def __init__(self, mock_file_root: str):
    ...
    def create_bucket(self, mock_bucket_name: str) -> None:
    ...
    def write_data(self, bucket: str, data: bytes, full_path: str) -> None:
