...
class SparkPersistor(AbstractDataPersistor):
    ...
    def persist_current_wicker_dataset(
        ...
        def parse_row(
            ...
            :rtype: ParsedExample
            """
            return dataparsing.parse_example(data_row, current_schema)

        logging.warning(self._current_rdd)
        rdd0 = self._current_rdd.mapValues(parse_row)  # type: ignore
        logging.warning(rdd0)
        ...
        def get_row_keys(
            ...
            return (partition,) + tuple(data[pk] for pk in current_schema.primary_keys)
        ...
        def persist_spark_partition_wicker(
            ...
            heavy_pointer_columns = current_schema.get_pointer_columns()
            metadata_columns = current_schema.get_non_pointer_columns()
